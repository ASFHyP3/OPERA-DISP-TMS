...
def create_granule_metadata_dict(granule: Granule) -> dict:
    ...
    ref_point_colrow, ref_point_eastingnorthing, epsg, reference_date, secondary_date, frame = granule_info
    frame_metadata = {}
    frame_metadata[f'FRAME_{frame}_REF_POINT_COLROW'] = ', '.join([str(x) for x in ref_point_colrow])
